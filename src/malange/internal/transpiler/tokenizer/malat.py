...
class MalangeTokenizer:
        ...
        while ind < len(file):
            ...
            if self.__mode == "normal":
                ...
                # Check for HTML tags.
                    ...
                    new_ind, js = self.__process_html_tag(file[ind+1:], ind)
                    if js:
                        self.__mode = "js"
    ...
    def __process_html_tag(self, file: str, sind: int) -> tuple[int, bool]:
        ...
        # ------
        close:         bool = False  # Whether the tag is closed or not.
        js:            bool = False  # Indicating that the variable is a JS variable.
    ...
    def __process_js_text(self, char: str, pchar: str, nchar: str, ind: int) -> None:
        ...
        if char == "/" and not self.__js_comment == "" and self.__js_string == "":
        ...
        elif char == "\\" and not self.__js_comment == "" and self.__js_string in ("'", '"'):
